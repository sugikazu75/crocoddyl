...
struct DifferentialActionDataFreeThrustFwdDynamicsTpl
  ...
  typedef typename MathBase::VectorXs VectorXs;
  typedef typename MathBase::MatrixXs MatrixXs;
  typedef typename Eigen::Tensor<Scalar, 3> Tensor3s;
  ...
  explicit DifferentialActionDataFreeThrustFwdDynamicsTpl(
      ...
      : Base(model),
        ...
        fext(pinocchio::container::aligned_vector<Force>(
            model->get_pinocchio().njoints, Force::Zero())),
        joint_hessian_tmp(6, model->get_state()->get_nv(),
  ...
  pinocchio::container::aligned_vector<Force>
      fext;  //!< External forces generated by
             //!< the rotors
  Tensor3s joint_hessian_tmp;
